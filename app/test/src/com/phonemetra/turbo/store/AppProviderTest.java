...
public class AppProviderTest extends StoreProviderTest<AppProvider> {
    ...
    public void testUris() {
        ...
        App app = new App();
        app.id = "com.phonemetra.turbo.store";
        ...
        assertValidUri(AppProvider.getContentUri("com.phonemetra.turbo.store"));
    }
    ...
    public void testInsert() {
        ...
        // Insert a new record...
        insertApp("com.phonemetra.turbo.store", "Turbo Store");
        cursor = queryAllApps();
        assertNotNull(cursor);
        ...
        assertEquals("com.phonemetra.turbo.store", app.id);
        assertEquals("Turbo Store", app.name);
    }
