...
public class InstallIntoSystemDialogActivity extends FragmentActivity {
    ...
    private void firstTime() {
        ...
        ContextThemeWrapper theme = new ContextThemeWrapper(this, StoreApp.getCurThemeResId());
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(theme)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        InstallIntoSystemDialogActivity.this.finish();
                        startActivity(new Intent(InstallIntoSystemDialogActivity.this, Store.class));
                    }
                })
                .setCancelable(false);
        builder.create().show();
