...
package com.phonemetra.turbo.store.installer;
...
abstract class InstallIntoSystem {
    ...
    final void runUninstall() {
        final String[] commands = {
                "am force-stop com.phonemetra.turbo.store",
                "pm clear com.phonemetra.turbo.store",
    ...
    protected String getInstallPath() {
        return getSystemFolder() + "TurboStore.apk";
    }
    ...
    private List<String> getInstallCommands() {
        ...
        commands.add("am force-stop com.phonemetra.turbo.store");
    ...
    protected List<String> getPostInstallCommands() {
        ...
        commands.add("am start -n com.phonemetra.turbo.store/.installer.InstallIntoSystemDialogActivity --ez post_install true");
        return commands;
    }
