...
/**
 * Given a {@link com.phonemetra.turbo.store.net.Downloader}, this wrapper will conduct the download operation on a
...
public class AsyncDownloadWrapper extends Handler {
     ...
     * relevant {@link com.phonemetra.turbo.store.net.AsyncDownloadWrapper.Listener}
     * @param message
     */
