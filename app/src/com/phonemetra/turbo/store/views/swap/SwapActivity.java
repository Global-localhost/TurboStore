...
public class SwapActivity extends ActionBarActivity implements SwapProcessManager {
        ...
        if (savedInstanceState == null) {
            ...
            new Handler().post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (StoreApp.isLocalRepoServiceRunning()) {
                        showSelectApps();
                        showJoinWifi();
                        attemptToShowNfc();
                        showWifiQr();
    ...
    private boolean attemptToShowNfc() {
        ...
        boolean nfcMessageReady = NfcHelper.setPushMessage(this, Utils.getSharingUri(StoreApp.repo));
    ...
    private void ensureLocalRepoRunning() {
        if (!StoreApp.isLocalRepoServiceRunning()) {
            StoreApp.startLocalRepoService(this);
    ...
    private void initLocalRepoTimer(long timeoutMilliseconds) {
        ...
        shutdownLocalRepoTimer.schedule(new TimerTask() {
            @Override
            public void run() {
                StoreApp.stopLocalRepoService(SwapActivity.this);
            }
        }, timeoutMilliseconds);
    ...
    class UpdateAsyncTask extends AsyncTask<Void, String, Void> {
        ...
        public UpdateAsyncTask(Context c, @NonNull Set<String> apps) {
            ...
            sharingUri = Utils.getSharingUri(StoreApp.repo);
        }
