...
import com.phonemetra.turbo.store.PreferencesActivity;
...
public class PreferencesFragment extends PreferenceFragment
    ...
    protected void updateSummary(String key, boolean changing) {
        ...
        case Preferences.PREF_LANGUAGE:
            ...
            if (changing) {
                result |= PreferencesActivity.RESULT_RESTART;
                getActivity().setResult(result);
                StoreApp.updateLanguage(this.getActivity());
            }
            break;
    ...
    /**
     * Initializes SystemInstaller preference, which can only be enabled when Turbo Store is installed as a system-app
     */
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                if (pref.isChecked()) {
                    if (Installer.hasSystemPermissions(getActivity(), getActivity().getPackageManager())) {
                        // system-permission are granted, i.e. Turbo Store is a system-app
