...
public class AppProvider extends StoreProvider {
     ...
     * {@link com.phonemetra.turbo.store.data.QuerySelection#add(QuerySelection)} and
     * {@link com.phonemetra.turbo.store.data.QuerySelection#add(String, String[])} methods
     * will only return the base class {@link com.phonemetra.turbo.store.data.QuerySelection}
     * which is not aware of the installed app table.
     * However, the
     * {@link com.phonemetra.turbo.store.data.AppProvider.AppQuerySelection#add(com.phonemetra.turbo.store.data.AppProvider.AppQuerySelection)}
    ...
    /**
     * Made static so that the {@link com.phonemetra.turbo.store.data.AppProvider.UpgradeHelper} can access
