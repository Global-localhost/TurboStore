...
public class NewRepoConfig {
    ...
    private void init(Context context, Uri incomingUri) {
        ...
        if (Arrays.asList("FDROIDREPO", "FDROIDREPOS").contains(scheme)) {
             ...
             * the special Turbo Store scheme being all is upper case means it
             * should be downcased.
             */
     ...
     * URL, then you will probably want {@link com.phonemetra.turbo.store.data.NewRepoConfig#getRepoUri()}.
     */
