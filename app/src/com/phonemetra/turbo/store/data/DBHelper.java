package com.phonemetra.turbo.store.data;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        */
        insertRepo(
                db,
                context.getString(R.string.phonemetra_repo_name),
                context.getString(R.string.phonemetra_repo_address),
                context.getString(R.string.phonemetra_repo_description),
                context.getString(R.string.phonemetra_repo_pubkey),
                context.getResources().getInteger(R.integer.phonemetra_repo_version),
                context.getResources().getInteger(R.integer.phonemetra_repo_inuse),
                context.getResources().getInteger(R.integer.phonemetra_repo_priority)
        );
    }
    ...
    private void addNameAndDescriptionToRepo(SQLiteDatabase db, int oldVersion) {
        ...
        if (oldVersion < 21 && !(nameExists && descriptionExists)) {
            ...
            */
            insertNameAndDescription(db, R.string.phonemetra_repo_address,
                    R.string.phonemetra_repo_name, R.string.phonemetra_repo_description);
        }
    ...
    private void resetTransient(SQLiteDatabase db, int oldVersion) {
        ...
        // just before 42 (Turbo Store 0.60ish) it now has "ignore this version" info which
