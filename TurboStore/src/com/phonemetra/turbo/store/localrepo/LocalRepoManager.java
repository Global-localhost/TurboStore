...
public class LocalRepoManager {
    ...
    private String writeFdroidApkToWebroot() {
        ...
        String fdroidClientURL = "https://f-droid.org/TurboStore.apk";
        ...
        try {
            ...
            Log.e(TAG, "Could not set up Turbo Store apk in the webroot", e);
        }
    ...
    public static class IndexXmlBuilder {
        ...
        private void tagRepo() throws IOException, LocalRepoKeyStore.InitException {
            ...
            serializer.attribute("", "name", Preferences.get().getLocalRepoName() + " on " + StoreApp.ipAddressString);
        ...
        /**
         * Alias for {@link com.phonemetra.turbo.store.localrepo.LocalRepoManager.IndexXmlBuilder#tag(String, String)}
