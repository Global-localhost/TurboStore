package com.phonemetra.turbo.store.localrepo;
...
import com.phonemetra.turbo.store.net.LocalHTTPD;
...
public class LocalRepoService extends Service {
    ...
    public static final String STATE = "com.phonemetra.turbo.store.action.LOCAL_REPO_STATE";
    public static final String STARTED = "com.phonemetra.turbo.store.category.LOCAL_REPO_STARTED";
    public static final String STOPPED = "com.phonemetra.turbo.store.category.LOCAL_REPO_STOPPED";
        ...
        Runnable webServer = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    int prev = StoreApp.port;
                    StoreApp.port = StoreApp.port + new Random().nextInt(1111);
                    Log.w(TAG, "port " + prev + " occupied, trying on " + StoreApp.port + "!");
    ...
    private void registerMDNSService() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                values.put("fingerprint", StoreApp.repo.fingerprint);
                String type;
                ...
                try {
                    pairService = ServiceInfo.create(type, repoName, StoreApp.port, 0, 0, values);
                    jmdns = JmDNS.create();
