...
import com.phonemetra.turbo.store.Preferences.ChangeListener;
import com.phonemetra.turbo.store.compat.PRNGFixes;
import com.phonemetra.turbo.store.data.AppProvider;
import com.phonemetra.turbo.store.data.InstalledAppCacheUpdater;
import com.phonemetra.turbo.store.data.Repo;
import com.phonemetra.turbo.store.localrepo.LocalRepoService;
import com.phonemetra.turbo.store.net.IconDownloader;
...
public class StoreApp extends Application {
    ...
    public void onCreate() {
        ...
        tracker = analytics.newTracker("UA-68907335-2");
        ...
        // Index files which downloaded, but were not removed (e.g. due to Turbo Store being force
        ...
        // As above, but for legacy Turbo Store clients that downloaded under a different name, and
        ...
        // device until they uninstall and re-install Turbo Store.
        ...
        Preferences.get().registerLocalRepoHttpsListeners(new ChangeListener() {
            @Override
            public void onPreferenceChange() {
                startService(new Intent(StoreApp.this, WifiStateChangeService.class));
            }
        });
    }
