...
import com.phonemetra.turbo.store.NfcHelper;
import com.phonemetra.turbo.store.NfcNotEnabledActivity;
...
public class RepoDetailsActivity extends ActionBarActivity {
    ...
    public static final String MIME_TYPE = "application/vnd.com.phonemetra.turbo.store.repo";
    ...
    public void onResume() {
        ...
        // Store.java and AppDetails set different NFC actions, so reset here
        setNfc();
