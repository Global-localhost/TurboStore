...
public class ConnectSwapActivity extends ActionBarActivity {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            */
                ...
                case UpdateService.STATUS_ERROR_GLOBAL:
                    // TODO: Show message on this screen (with a big "okay" button that goes back to Turbo Store activity)
    ...
    private Repo ensureRepoExists() {
        ...
        if (!newRepoConfig.preventFurtherSwaps() && StoreApp.isLocalRepoServiceRunning()) {
    ...
    private void askServerToSwapWithUs() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... args) {
                ...
                String swapBackUri = Utils.getLocalRepoUri(StoreApp.repo).toString();

                AndroidHttpClient client = AndroidHttpClient.newInstance("Turbo Store", ConnectSwapActivity.this);
