...
public class ApkProvider extends StoreProvider {
     ...
     * {@link com.phonemetra.turbo.store.data.ApkProvider#MAX_APKS_TO_QUERY}. Instead of using
     * this directly, think about using
     * {@link com.phonemetra.turbo.store.data.ApkProvider.Helper#knownApks(android.content.Context, java.util.List, String[])}
     */
