...
public class ApkProviderHelperTest extends BaseApkProviderTest {
    ...
    public void testKnownApks() {
        ...
        Apk[] known = {
            new MockApk("com.phonemetra.turbo.store", 1),
            new MockApk("com.phonemetra.turbo.store", 3),
            new MockApk("com.phonemetra.turbo.store", 5),
        ...
        Apk[] unknown = {
            new MockApk("com.phonemetra.turbo.store", 7),
            new MockApk("com.phonemetra.turbo.store", 9),
            new MockApk("com.phonemetra.turbo.store", 11),
            new MockApk("com.phonemetra.turbo.store", 13),
    ...
    public void testFindByApp() {
        ...
        List<Apk> fdroidApks = ApkProvider.Helper.findByApp(getMockContext(), "com.phonemetra.turbo.store");
