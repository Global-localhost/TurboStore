...
import com.phonemetra.turbo.store.receiver.PackageAddedReceiver;
import com.phonemetra.turbo.store.receiver.PackageRemovedReceiver;
import com.phonemetra.turbo.store.receiver.PackageUpgradedReceiver;
...
public class TestUtils {
    ...
    public static Uri insertApk(StoreProviderTest<ApkProvider> providerTest, String id, int versionCode) {
        return insertApk(providerTest, id, versionCode, new ContentValues());
    }

    public static Uri insertApk(StoreProviderTest<ApkProvider> providerTest, String id, int versionCode, ContentValues additionalValues) {
     ...
     * {@link com.phonemetra.turbo.store.receiver.PackageAddedReceiver}. This will in turn update the
    ...
    /**
     * @see com.phonemetra.turbo.store.TestUtils#installAndBroadcast(mock.MockContextSwappableComponents, mock.MockInstallablePackageManager, String, int, String)
     */
