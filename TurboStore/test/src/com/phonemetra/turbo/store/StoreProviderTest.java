...
import com.phonemetra.turbo.store.data.StoreProvider;
...
import mock.MockStoreResources;

public abstract class StoreProviderTest<T extends StoreProvider> extends ProviderTestCase2MockContext<T> {

    private StoreProvider[] allProviders = {
        new AppProvider(),
        new RepoProvider(),
        new ApkProvider(),
    ...
    public StoreProviderTest(Class<T> providerClass, String providerAuthority) {
        super(providerClass, providerAuthority);
    }

    protected Resources getMockResources() {
        return new MockStoreResources(getContext());
    }
    ...
    public void setUp() throws Exception {
        ...
        // This is because Turbo Store providers tend to perform joins onto tables managed by other
        // providers, and so we need to be able to insert into those other providers for these
        // joins to be tested correctly.
        for (StoreProvider provider : allProviders) {
